...
# Control granular de categorías (opciones mutuamente excluyentes)
py anonimizar.py [ruta] --ley rgpd --excluir ubicacion dni-es
py anonimizar.py [ruta] --ley rgpd --incluir persona email telefono
py anonimizar.py --lista-categorias
